...
<div class="panel-body" style="height:100%;color:whitesmoke;"><h1 style="">' + workout.to_s + '</h1><img src="images/exercises/'+ item +'" style="max-height: 300px; max-width:300px;float:right">  </div></div>'
      end
    end
  end
  return @resultString
